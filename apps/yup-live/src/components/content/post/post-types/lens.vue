<template>
  ...
  <div v-if="lensComments.length > 0" class="p-2 flex-col">
...
import LensPostBody from '@/components/content/post/post-types/lens/lensPostBody.vue'
import snarkdown from 'snarkdown'
import { commentLensQuery, lensIdToRaw, convertToWeb3Raw, rawToLensId } from 'shared/dist/utils/web3/lens'
import type { OpenGraphPreview, mediaType } from 'shared/dist/types/post'
import type { Web3LensRaw, Web3PostLens } from 'shared/dist/types/web3/lens'
