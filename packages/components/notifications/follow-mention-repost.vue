        ...
        <div class="flex flex-col w-full">
          <div class="flex">
            <p class="ml-3 flex items-center pb-2 mt-4">
              ...
              <template v-if="type === 'follow'"> started following you </template>
              <template v-else-if="type === 'unfollow'"> has unfollowed you </template>
              <template v-else-if="type === 'mention'">
                mentioned you in a post
              </template>
              <template v-else-if="type === 'repost'"> reposted your post </template>
              <span
