<template>
  ...
  <div v-else :key="`loading-${loading}`">
    <div class="flex flex-row-reverse justify-between -mt-2 px-4" style="z-index: 1">
      <span class="inline-block favIco"><MirrorIcon class="w-8 tIcon" /> </span>
    </div>
...
import MirrorIcon from '@/components/content/icons/mirror.vue'
