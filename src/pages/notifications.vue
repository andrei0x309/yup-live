                ...
                <div class="flex flex-col w-full">
                  ...
                  <p class="ml-3 mt-3 flex items-center w-full">
                    ...
                    ><span style="font-size: 0.78rem"
                      ><router-link :to="`/p/${notification?.post?.postid}`">{{ notification?.post?.url }}</router-link></span
                    >
                  </p>
...
export default defineComponent({
  ...
  setup() {
    ...
    const getNotifications = async (
      { type, limit, skip } = { type: 'all', limit: '10', skip: '0' } as { type: string; limit?: string; skip?: string }
    ) => {
      let req
